...
object PredictorRFTiLRWithHisP extends PredictorWithHis {

  override var identifier: String = "RFTiLRWithHisP"
...
//      val multiplier = (1.0 / (1.0 + math.exp(margin))) - label
      ...
      if (label > 0.5) {
        ...
        dateMultiplier * (math.log(1 + math.exp(margin)) - margin * (1 - gamma))
      }
